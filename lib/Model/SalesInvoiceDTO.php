 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SalesInvoiceDTO implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SalesInvoiceDTO';
    ...
    protected static $swaggerTypes = [
        ...
        'payment_exchange_rate' => '\Swagger\Client\Model\PaymentExchangeRateDTO',
        'delivery_terms' => '\Swagger\Client\Model\DeliveryTermDTO',
        'additional_notification_emails' => 'string[]',
        'payment_means' => '\Swagger\Client\Model\PaymentMeanDTO[]',
        'payment_terms' => '\Swagger\Client\Model\PaymentTermDTO[]',
        'allowance_charges' => '\Swagger\Client\Model\AllowanceChargeDTO[]',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['authorization_number'] === null) {
            $invalid_properties[] = "'authorization_number' can't be null";
        }
    ...
    /**
     * Sets notes_pdf
     * @param \Swagger\Client\Model\NoteDTO[] $notes_pdf Adicional information for the pdf
     * @return $this
     */
     ...
     * @param string $authorization_number Authorization number of series range provided by DIAN
     * @return $this
     */
     ...
     * @return \Swagger\Client\Model\PaymentExchangeRateDTO
     */
     ...
     * @param \Swagger\Client\Model\PaymentExchangeRateDTO $payment_exchange_rate Payment Exchange Rate
     * @return $this
     */
    ...
    /**
     * Gets delivery_terms
     * @return \Swagger\Client\Model\DeliveryTermDTO
     */
    ...
    /**
     * Sets delivery_terms
     * @param \Swagger\Client\Model\DeliveryTermDTO $delivery_terms Document delivery terms
     * @return $this
     */
    ...
    /**
     * Gets payment_means
     * @return \Swagger\Client\Model\PaymentMeanDTO[]
     */
    ...
    /**
     * Sets payment_means
     * @param \Swagger\Client\Model\PaymentMeanDTO[] $payment_means Document payment means
     * @return $this
     */
    ...
    /**
     * Gets payment_terms
     * @return \Swagger\Client\Model\PaymentTermDTO[]
     */
    ...
    /**
     * Sets payment_terms
     * @param \Swagger\Client\Model\PaymentTermDTO[] $payment_terms Document payment terms
     * @return $this
     */
     ...
     * @return \Swagger\Client\Model\AllowanceChargeDTO[]
     */
     ...
     * @param \Swagger\Client\Model\AllowanceChargeDTO[] $allowance_charges Document allowances and charges
     * @return $this
     */
     ...
     * @param \Swagger\Client\Model\DocumentReferenceDTO[] $document_references Document references
     * @return $this
     */
