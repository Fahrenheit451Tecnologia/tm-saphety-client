<?php
/**
 * DocumentStatisticsCriteriaInputDto
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * DocumentStatisticsCriteriaInputDto Class Doc Comment
 *
 * @category Class
 * @description Document statistics criteria
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentStatisticsCriteriaInputDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DocumentStatisticsCriteriaInputDto';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['search_interval'] === null) {
            $invalidProperties[] = "'search_interval' can't be null";
        }
     ...
     *
     * @param string $search_interval \"24HOURS,5DAYS,30DAYS
     *
     * @return $this
     */
