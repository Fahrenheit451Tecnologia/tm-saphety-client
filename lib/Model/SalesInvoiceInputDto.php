...
class SalesInvoiceInputDto implements ModelInterface, ArrayAccess
{
     ...
     * Sets serie_prefix
     *
     * @param string $serie_prefix If the serie selected by SerieExternalKey is Autoincrement, this field must be empty.  The document number will be assigned by the system.  Id the serie selected by SerieExternalKey is not Autoincrement, the prefix must be present.  Serie validations will be applied.
     *
     * @return $this
     */
     ...
     * Sets serie_number
     *
     * @param string $serie_number If the serie selected by SerieExternalKey is Autoincrement, this field must be empty.  The document number will be assigned by the system.  Id the serie selected by SerieExternalKey is not Autoincrement, the SerieNumber must be present.  Serie validations will be applied.
     *
     * @return $this
     */
     ...
     * Sets delivery_terms
     *
     * @param \Swagger\Client\Model\DeliveryTermInputDto $delivery_terms Document delivery terms
     *
     * @return $this
     */
     ...
     * Sets payment_means
     *
     * @param \Swagger\Client\Model\PaymentMeanInputDto[] $payment_means Document payment means
     *
     * @return $this
     */
     ...
     * Sets payment_terms
     *
     * @param \Swagger\Client\Model\PaymentTermInputDto[] $payment_terms Document payment terms
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\AllowanceChargeInputDto[] $allowance_charges Document allowances and charges
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\DocumentReferenceInputDto[] $document_references Document references
     *
     * @return $this
     */
    ...
    public function setPdf($pdf)
    {
        if (!is_null($pdf) && (strlen($pdf) > 5000000)) {
            throw new \InvalidArgumentException('invalid length for $pdf when calling SalesInvoiceInputDto., must be smaller than or equal to 5000000.');
        }
        if (!is_null($pdf) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $pdf))) {
            throw new \InvalidArgumentException("invalid value for $pdf when calling SalesInvoiceInputDto., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
