 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CreditNoteDTO implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reason_credit'] === null) {
            $invalid_properties[] = "'reason_credit' can't be null";
        }
    ...
    /**
     * Sets issue_date
     * @param \DateTime $issue_date Date issue of credit note. Format {yyyy-mm-dd}
     * @return $this
     */
    ...
    /**
     * Sets due_date
     * @param \DateTime $due_date Credit Note due date. Format {yyyy-mm-dd}
     * @return $this
     */
    ...
    /**
     * Sets delivery_date
     * @param \DateTime $delivery_date Credit Note Delivery Date. Format {yyyy-mm-dd}
     * @return $this
     */
     ...
     * @param \Swagger\Client\Model\DocumentReferenceDTO[] $document_references Documents(Sales Invoice, Exportation Invoice) refered to the credit note
     * @return $this
     */
    ...
    /**
     * Sets lines
     * @param \Swagger\Client\Model\LineDTO[] $lines Credit note lines
     * @return $this
     */
     ...
     * @param \Swagger\Client\Model\DocumentAttachmentDTO[] $document_attachments
     * @return $this
     */
    ...
    /**
     * Sets total
     * @param \Swagger\Client\Model\LegalMonetaryTotalDTO $total Relating to the total amounts applicable to the credit note
     * @return $this
     */
