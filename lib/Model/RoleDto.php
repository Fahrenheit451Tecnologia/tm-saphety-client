...
class RoleDto implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['permission_level'], $allowedValues)) {
    ...
    {
        $allowedValues = $this->getPermissionLevelAllowableValues();
        if (!is_null($permission_level) && !in_array($permission_level, $allowedValues)) {
     ...
     * Sets permission_ids
     *
     * @param string[] $permission_ids permission_ids
     *
     * @return $this
     */
     ...
     * Sets permissions
     *
     * @param \Swagger\Client\Model\PermissionDTO[] $permissions permissions
     *
     * @return $this
     */
