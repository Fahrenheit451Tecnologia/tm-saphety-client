...
class ItemInputDto implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['gtin']) && (strlen($this->container['gtin']) > 20)) {
            $invalidProperties[] = "invalid value for 'gtin', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['buyer_item_identification']) && (strlen($this->container['buyer_item_identification']) > 20)) {
            $invalidProperties[] = "invalid value for 'buyer_item_identification', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['seller_item_identification']) && (strlen($this->container['seller_item_identification']) > 20)) {
            $invalidProperties[] = "invalid value for 'seller_item_identification', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['serial_number']) && (strlen($this->container['serial_number']) > 20)) {
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['gtin']) > 20) {
            return false;
        }
        if (strlen($this->container['buyer_item_identification']) > 20) {
            return false;
        }
        if (strlen($this->container['seller_item_identification']) > 20) {
            return false;
        }
        if (strlen($this->container['serial_number']) > 20) {
            return false;
        }
        if ($this->container['description'] === null) {
            return false;
        ...
        if (strlen($this->container['brand_name']) > 20) {
            return false;
        }
        if (strlen($this->container['model_name']) > 20) {
            return false;
        }
        if (strlen($this->container['pack_quantity']) > 19) {
            return false;
        }
        if (strlen($this->container['units_per_package']) > 19) {
            return false;
        }
        if (strlen($this->container['height']) > 19) {
            return false;
        }
        if (strlen($this->container['width']) > 19) {
            return false;
        }
        if (strlen($this->container['depth']) > 19) {
            return false;
        }
        if (strlen($this->container['volume']) > 19) {
            return false;
        }
        if (strlen($this->container['lot_number']) > 20) {
            return false;
        }
        return true;
    }
     ...
     * Sets gtin
     *
     * @param string $gtin Item identification GTIN; MaxLength: 20
     *
     * @return $this
     */
    public function setGtin($gtin)
    {
        if (!is_null($gtin) && (strlen($gtin) > 20)) {
     ...
     *
     * @param string $buyer_item_identification Item code assigned by buyer; MaxLength: 20
     *
     * @return $this
     */
    public function setBuyerItemIdentification($buyer_item_identification)
    {
        if (!is_null($buyer_item_identification) && (strlen($buyer_item_identification) > 20)) {
     ...
     *
     * @param string $seller_item_identification Item code assigned by seller = SKU; MaxLength: 20
     *
     * @return $this
     */
    public function setSellerItemIdentification($seller_item_identification)
    {
        if (!is_null($seller_item_identification) && (strlen($seller_item_identification) > 20)) {
     ...
     * Sets serial_number
     *
     * @param string $serial_number SerialNumber; MaxLength: 20
     *
     * @return $this
     */
    public function setSerialNumber($serial_number)
    {
        if (!is_null($serial_number) && (strlen($serial_number) > 20)) {
     ...
     * Sets description
     *
     * @param string $description Item description belonging to the invoice line; MaxLength: 400
     *
     * @return $this
     */
     ...
     * Sets brand_name
     *
     * @param string $brand_name Brand name; MaxLength: 20
     *
     * @return $this
     */
    public function setBrandName($brand_name)
    {
        if (!is_null($brand_name) && (strlen($brand_name) > 20)) {
     ...
     * Sets model_name
     *
     * @param string $model_name Model name; MaxLength: 20
     *
     * @return $this
     */
    public function setModelName($model_name)
    {
        if (!is_null($model_name) && (strlen($model_name) > 20)) {
     ...
     * Sets pack_quantity
     *
     * @param string $pack_quantity Number of packages; MaxLength: 19
     *
     * @return $this
     */
    public function setPackQuantity($pack_quantity)
    {
        if (!is_null($pack_quantity) && (strlen($pack_quantity) > 19)) {
     ...
     *
     * @param string $units_per_package Number of items per package; MaxLength: 19
     *
     * @return $this
     */
    public function setUnitsPerPackage($units_per_package)
    {
        if (!is_null($units_per_package) && (strlen($units_per_package) > 19)) {
     ...
     * Sets height
     *
     * @param string $height Height of item; MaxLength: 19
     *
     * @return $this
     */
    public function setHeight($height)
    {
        if (!is_null($height) && (strlen($height) > 19)) {
     ...
     * Sets width
     *
     * @param string $width Width of item; MaxLength: 19
     *
     * @return $this
     */
    public function setWidth($width)
    {
        if (!is_null($width) && (strlen($width) > 19)) {
     ...
     * Sets depth
     *
     * @param string $depth Depth of item; MaxLength: 19
     *
     * @return $this
     */
    public function setDepth($depth)
    {
        if (!is_null($depth) && (strlen($depth) > 19)) {
     ...
     * Sets volume
     *
     * @param string $volume Volume of item; MaxLength: 19
     *
     * @return $this
     */
    public function setVolume($volume)
    {
        if (!is_null($volume) && (strlen($volume) > 19)) {
     ...
     * Sets lot_number
     *
     * @param string $lot_number lot number; MaxLength: 20
     *
     * @return $this
     */
    public function setLotNumber($lot_number)
    {
        if (!is_null($lot_number) && (strlen($lot_number) > 20)) {
