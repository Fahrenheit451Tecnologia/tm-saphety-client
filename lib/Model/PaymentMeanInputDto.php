...
class PaymentMeanInputDto implements ModelInterface, ArrayAccess
{
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['bank_guarantee']) > 200) {
            return false;
        }
        if (strlen($this->container['bank_transfer_number']) > 100) {
            return false;
        }
        if (strlen($this->container['bank_id']) > 100) {
            return false;
        }
        if (strlen($this->container['bank_name']) > 100) {
            return false;
        }
        return true;
    }
     ...
     * Sets code
     *
     * @param string $code UN/ECE 4461 http://www.unece.org/trade/untdid/d03a/tred/tred4461.htm  This is a partial list
     *
     * @return $this
     */
     ...
     * Sets channel_code
     *
     * @param string $channel_code DataElements.PaymentChannelType
     *
     * @return $this
     */
     ...
     *
     * @param string $payment_instruction DataElements.PaymentInstructionType
     *
     * @return $this
     */
     ...
     *
     * @param string $days_type_to_pay DataElements.PaymentDaysType
     *
     * @return $this
     */
    ...
    {
        if (!is_null($bank_guarantee) && (strlen($bank_guarantee) > 200)) {
    ...
    {
        if (!is_null($bank_transfer_number) && (strlen($bank_transfer_number) > 100)) {
    ...
    {
        if (!is_null($bank_id) && (strlen($bank_id) > 100)) {
    ...
    {
        if (!is_null($bank_name) && (strlen($bank_name) > 100)) {
