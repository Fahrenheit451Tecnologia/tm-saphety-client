...
/**
 * TechnologicalProviderUpdateInputDto Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TechnologicalProviderUpdateInputDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TechnologicalProviderUpdateInputDto';
    ...
    {
        if ((strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TechnologicalProviderUpdateInputDto., must be smaller than or equal to 100.');
        }
    ...
    {
        if ((strlen($nit) > 15)) {
            throw new \InvalidArgumentException('invalid length for $nit when calling TechnologicalProviderUpdateInputDto., must be smaller than or equal to 15.');
        }
