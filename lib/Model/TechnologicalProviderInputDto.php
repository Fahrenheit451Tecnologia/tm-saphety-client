...
/**
 * TechnologicalProviderInputDto Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TechnologicalProviderInputDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TechnologicalProviderInputDto';
    ...
    protected static $swaggerTypes = [
        ...
        'inbound_configuration_password' => 'string',
    ...
    protected static $swaggerFormats = [
        ...
        'inbound_configuration_password' => null,
    ...
    protected static $attributeMap = [
        ...
        'inbound_configuration_password' => 'InboundConfigurationPassword',
    ...
    protected static $setters = [
        ...
        'inbound_configuration_password' => 'setInboundConfigurationPassword',
    ...
    protected static $getters = [
        ...
        'inbound_configuration_password' => 'getInboundConfigurationPassword',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['inbound_configuration_password'] = isset($data['inbound_configuration_password']) ? $data['inbound_configuration_password'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['nit'] === null) {
            $invalidProperties[] = "'nit' can't be null";
        }
        if ((strlen($this->container['nit']) > 15)) {
            $invalidProperties[] = "invalid value for 'nit', the character length must be smaller than or equal to 15.";
        }

        if ($this->container['inbound_configuration_username'] === null) {
            $invalidProperties[] = "'inbound_configuration_username' can't be null";
        }
        if ($this->container['outbound_configuration_contingency_email'] === null) {
            $invalidProperties[] = "'outbound_configuration_contingency_email' can't be null";
        }
    ...
    {
        if ((strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TechnologicalProviderInputDto., must be smaller than or equal to 100.');
        }
    ...
    {
        if ((strlen($nit) > 15)) {
            throw new \InvalidArgumentException('invalid length for $nit when calling TechnologicalProviderInputDto., must be smaller than or equal to 15.');
        }
    ...
    /**
     * Gets inbound_configuration_password
     *
     * @return string
     */
    public function getInboundConfigurationPassword()
    {
        return $this->container['inbound_configuration_password'];
    }

    /**
     * Sets inbound_configuration_password
     *
     * @param string $inbound_configuration_password inbound_configuration_password
     *
     * @return $this
     */
    public function setInboundConfigurationPassword($inbound_configuration_password)
    {
        $this->container['inbound_configuration_password'] = $inbound_configuration_password;
