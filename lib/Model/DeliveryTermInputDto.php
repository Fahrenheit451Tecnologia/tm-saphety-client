...
class DeliveryTermInputDto implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['special_terms']) && (strlen($this->container['special_terms']) > 200)) {
            $invalidProperties[] = "invalid value for 'special_terms', the character length must be smaller than or equal to 200.";
        }

        if (!is_null($this->container['incoterm_code']) && (strlen($this->container['incoterm_code']) > 200)) {
            $invalidProperties[] = "invalid value for 'incoterm_code', the character length must be smaller than or equal to 200.";
        }

        if (!is_null($this->container['delivery_code']) && (strlen($this->container['delivery_code']) > 200)) {
            $invalidProperties[] = "invalid value for 'delivery_code', the character length must be smaller than or equal to 200.";
        }

        if (!is_null($this->container['delivery_description']) && (strlen($this->container['delivery_description']) > 200)) {
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['special_terms']) > 200) {
            return false;
        }
        if (strlen($this->container['incoterm_code']) > 200) {
            return false;
        }
        if (strlen($this->container['delivery_code']) > 200) {
            return false;
        }
        if (strlen($this->container['delivery_description']) > 200) {
            return false;
        }
        return true;
    }
     ...
     * Sets special_terms
     *
     * @param string $special_terms Special Terms; MaxLength: 200
     *
     * @return $this
     */
    public function setSpecialTerms($special_terms)
    {
        if (!is_null($special_terms) && (strlen($special_terms) > 200)) {
     ...
     * Sets incoterm_code
     *
     * @param string $incoterm_code Loss Risk Responsibility Code; MaxLength: 200
     *
     * @return $this
     */
    public function setIncotermCode($incoterm_code)
    {
        if (!is_null($incoterm_code) && (strlen($incoterm_code) > 200)) {
     ...
     * Sets delivery_code
     *
     * @param string $delivery_code Delivery Location Code; MaxLength: 200
     *
     * @return $this
     */
    public function setDeliveryCode($delivery_code)
    {
        if (!is_null($delivery_code) && (strlen($delivery_code) > 200)) {
     ...
     *
     * @param string $delivery_description Delivery Description; MaxLength: 200
     *
     * @return $this
     */
    public function setDeliveryDescription($delivery_description)
    {
        if (!is_null($delivery_description) && (strlen($delivery_description) > 200)) {
