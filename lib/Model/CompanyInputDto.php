...
/**
 * CompanyInputDto Class Doc Comment
 *
 * @category Class
 * @description Company
 * @package  Swagger\Client
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyInputDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyInputDto';
    ...
    protected static $swaggerTypes = [
        ...
        'medias' => '\Swagger\Client\Model\CompanyMediaInputDto[]',
        'inbound_configuration' => '\Swagger\Client\Model\CompanyInboundConfigurationInputDto',
        'id' => 'string',
        'telephone' => 'string',
        'legal_type' => 'string',
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['retention_type']) && (strlen($this->container['retention_type']) > 450)) {
            $invalidProperties[] = "invalid value for 'retention_type', the character length must be smaller than or equal to 450.";
        }

        if (!is_null($this->container['activities_description']) && (strlen($this->container['activities_description']) > 450)) {
            $invalidProperties[] = "invalid value for 'activities_description', the character length must be smaller than or equal to 450.";
        }

        if ($this->container['is_outbound_integrated'] === null) {
            $invalidProperties[] = "'is_outbound_integrated' can't be null";
        }
        if ($this->container['has_inbound_profile'] === null) {
            $invalidProperties[] = "'has_inbound_profile' can't be null";
        }
        if (!is_null($this->container['tax_information']) && (strlen($this->container['tax_information']) > 450)) {
            $invalidProperties[] = "invalid value for 'tax_information', the character length must be smaller than or equal to 450.";
        }

        if (!is_null($this->container['financial_support_email']) && (strlen($this->container['financial_support_email']) > 200)) {
            $invalidProperties[] = "invalid value for 'financial_support_email', the character length must be smaller than or equal to 200.";
        }
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['retention_type']) > 450) {
            return false;
        }
        if (strlen($this->container['activities_description']) > 450) {
            return false;
        }
        if ($this->container['is_outbound_integrated'] === null) {
            return false;
        ...
        if (strlen($this->container['tax_information']) > 450) {
            return false;
        }
        if (strlen($this->container['financial_support_email']) > 200) {
            return false;
        }
        if ($this->container['legal_type'] === null) {
            return false;
     ...
     * Sets timezone_code
     *
     * @param string $timezone_code Timezone; MaxLength: 50
     *
     * @return $this
     */
    public function setTimezoneCode($timezone_code)
    {
        if ((strlen($timezone_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $timezone_code when calling CompanyInputDto., must be smaller than or equal to 50.');
        }
     ...
     * Sets retention_type
     *
     * @param string $retention_type RetentionType; MaxLength: 450
     *
     * @return $this
     */
    public function setRetentionType($retention_type)
    {
        if (!is_null($retention_type) && (strlen($retention_type) > 450)) {
            throw new \InvalidArgumentException('invalid length for $retention_type when calling CompanyInputDto., must be smaller than or equal to 450.');
        }
     ...
     *
     * @param string $activities_description ActivitiesDescription; MaxLength: 450
     *
     * @return $this
     */
    public function setActivitiesDescription($activities_description)
    {
        if (!is_null($activities_description) && (strlen($activities_description) > 450)) {
            throw new \InvalidArgumentException('invalid length for $activities_description when calling CompanyInputDto., must be smaller than or equal to 450.');
        }
     ...
     *
     * @param string $tax_information TaxInformation; MaxLength: 450
     *
     * @return $this
     */
    public function setTaxInformation($tax_information)
    {
        if (!is_null($tax_information) && (strlen($tax_information) > 450)) {
            throw new \InvalidArgumentException('invalid length for $tax_information when calling CompanyInputDto., must be smaller than or equal to 450.');
        }
     ...
     *
     * @param string $financial_support_email Email to be used to \"reply\" and email body when sending notification emails; MaxLength: 200
     *
     * @return $this
     */
    public function setFinancialSupportEmail($financial_support_email)
    {
        if (!is_null($financial_support_email) && (strlen($financial_support_email) > 200)) {
            throw new \InvalidArgumentException('invalid length for $financial_support_email when calling CompanyInputDto., must be smaller than or equal to 200.');
        }
     ...
     * Gets medias
     *
     * @return \Swagger\Client\Model\CompanyMediaInputDto[]
     */
     ...
     * Sets medias
     *
     * @param \Swagger\Client\Model\CompanyMediaInputDto[] $medias Medias
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\CompanyInboundConfigurationInputDto
     */
     ...
     *
     * @param \Swagger\Client\Model\CompanyInboundConfigurationInputDto $inbound_configuration Inbound configuration
     *
     * @return $this
     */
    ...
    public function setIndustry($industry)
    {
        if (!is_null($industry) && (strlen($industry) > 100)) {
            throw new \InvalidArgumentException('invalid length for $industry when calling CompanyInputDto., must be smaller than or equal to 100.');
        }
    ...
    public function setLanguageCode($language_code)
    {
        if ((strlen($language_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $language_code when calling CompanyInputDto., must be smaller than or equal to 50.');
        }
