...
/**
 * PrepaidPaymentDTO Class Doc Comment
 *
 * @category    Class
 * @description Object representing a Prepaid payment
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PrepaidPaymentDTO implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PrepaidPaymentDTO';
    ...
    /**
     * Sets paid_date
     * @param \DateTime $paid_date The date the prepayment was made
     * @return $this
     */
    ...
    /**
     * Sets paid_amount
     * @param double $paid_amount The total paid amount for the given prepaid
     * @return $this
     */
