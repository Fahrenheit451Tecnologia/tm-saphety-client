...
/**
 * InboundDocumentSearchCriteriaInputDto Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InboundDocumentSearchCriteriaInputDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InboundDocumentSearchCriteriaInputDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['include_pdf'] = isset($data['include_pdf']) ? $data['include_pdf'] : null;
        $this->container['include_xml'] = isset($data['include_xml']) ? $data['include_xml'] : null;
    ...
    public function setDocumentNumber($document_number)
    {
        if (!is_null($document_number) && (strlen($document_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $document_number when calling InboundDocumentSearchCriteriaInputDto., must be smaller than or equal to 20.');
        }
    ...
    public function setCurrency($currency)
    {
        if (!is_null($currency) && (strlen($currency) > 50)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling InboundDocumentSearchCriteriaInputDto., must be smaller than or equal to 50.');
        }
     ...
     * Sets include_pdf
     *
     * @param bool $include_pdf include_pdf
     *
     * @return $this
     */
     ...
     * @return bool
     */
    public function getIncludeXml()
    {
        return $this->container['include_xml'];
    }

    /**
     * Sets include_xml
     *
     * @param bool $include_xml include_xml
     *
     * @return $this
     */
    public function setIncludeXml($include_xml)
    {
        $this->container['include_xml'] = $include_xml;
