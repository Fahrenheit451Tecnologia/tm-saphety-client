 ...
 *
 * @category Class
 * @description Referece to a line in another document
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentLineReferenceInputDto implements ModelInterface, ArrayAccess
{
     ...
     * Sets issue_date
     *
     * @param string $issue_date Referred document date
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Type of document reference. See DataElements.DocLineReferenceTypes
     *
     * @return $this
     */
