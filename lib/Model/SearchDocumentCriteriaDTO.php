 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SearchDocumentCriteriaDTO implements ArrayAccess
{
    ...
    {
        $allowed_values = $this->getDocumentTypesAllowableValues();
        if (!is_null($document_types) && array_diff($document_types, $allowed_values)) {
     ...
     * @param string[] $document_sub_types
     * @return $this
     */
    ...
    {
        $allowed_values = $this->getBusinessStatusAllowableValues();
        if (!is_null($business_status) && array_diff($business_status, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
    ...
    {
        $allowed_values = $this->getCommunicationStatusAllowableValues();
        if (!is_null($communication_status) && array_diff($communication_status, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
     ...
     * @param \DateTime $document_date_start
     * @return $this
     */
     ...
     * @param \DateTime $document_date_end
     * @return $this
     */
