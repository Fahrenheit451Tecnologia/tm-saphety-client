...
/**
 * SerieInputDto Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SerieInputDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SerieInputDto';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['prefix']) && (strlen($this->container['prefix']) > 4)) {
        ...
        if ($this->container['efective_value'] === null) {
            $invalidProperties[] = "'efective_value' can't be null";
        }
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['prefix']) > 4) {
            return false;
        }
        if ($this->container['valid_from'] === null) {
            return false;
     ...
     * Sets name
     *
     * @param string $name Serie name; MaxLength: 50
     *
     * @return $this
     */
    ...
    {
        if ((strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SerieInputDto., must be smaller than or equal to 50.');
        }
     ...
     * Sets prefix
     *
     * @param string $prefix Serie prefix; MaxLength: 4
     *
     * @return $this
     */
    public function setPrefix($prefix)
    {
        if (!is_null($prefix) && (strlen($prefix) > 4)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling SerieInputDto., must be smaller than or equal to 4.');
        }
     ...
     * Sets document_type
     *
     * @param string $document_type Document type of the serie. See DataElements.DocumentType
     *
     * @return $this
     */
