...
class AllowanceChargeInputDto implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['reason']) && (strlen($this->container['reason']) > 400)) {
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['reason']) > 400) {
            return false;
        }
        if ($this->container['amount'] === null) {
            return false;
     ...
     * Sets base_amount
     *
     * @param string $base_amount Amount for allowance or charge calculation
     *
     * @return $this
     */
     ...
     * Sets reason_code
     *
     * @param string $reason_code Code for allowance or charge. See DataElements.AllowanceChargeCodeType
     *
     * @return $this
     */
     ...
     * Sets reason
     *
     * @param string $reason Mandatory if invoice is internacional; MaxLength: 400
     *
     * @return $this
     */
    public function setReason($reason)
    {
        if (!is_null($reason) && (strlen($reason) > 400)) {
     ...
     *
     * @param string $sequence_indicator Calculation sequence indicator
     *
     * @return $this
     */
