 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TemplateTestDto implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ubl'] === null) {
            $invalidProperties[] = "'ubl' can't be null";
        }
    ...
    {
        $allowedValues = $this->getDocumentTypeAllowableValues();
        if (!in_array($document_type, $allowedValues)) {
    ...
    public function setLanguageCode($language_code)
    {
        if ((strlen($language_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $language_code when calling TemplateTestDto., must be smaller than or equal to 50.');
        }
