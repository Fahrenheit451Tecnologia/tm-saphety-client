...
/**
 * CompanyUpdateInputDto Class Doc Comment
 *
 * @category Class
 * @description Company
 * @package  Swagger\Client
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyUpdateInputDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyUpdateInputDto';
    ...
    public function setTimezoneCode($timezone_code)
    {
        if ((strlen($timezone_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $timezone_code when calling CompanyUpdateInputDto., must be smaller than or equal to 50.');
        }
    ...
    public function setRetentionType($retention_type)
    {
        if (!is_null($retention_type) && (strlen($retention_type) > 450)) {
            throw new \InvalidArgumentException('invalid length for $retention_type when calling CompanyUpdateInputDto., must be smaller than or equal to 450.');
        }
    ...
    public function setActivitiesDescription($activities_description)
    {
        if (!is_null($activities_description) && (strlen($activities_description) > 450)) {
            throw new \InvalidArgumentException('invalid length for $activities_description when calling CompanyUpdateInputDto., must be smaller than or equal to 450.');
        }
    ...
    public function setTaxInformation($tax_information)
    {
        if (!is_null($tax_information) && (strlen($tax_information) > 450)) {
            throw new \InvalidArgumentException('invalid length for $tax_information when calling CompanyUpdateInputDto., must be smaller than or equal to 450.');
        }
    ...
    public function setFinancialSupportEmail($financial_support_email)
    {
        if (!is_null($financial_support_email) && (strlen($financial_support_email) > 200)) {
            throw new \InvalidArgumentException('invalid length for $financial_support_email when calling CompanyUpdateInputDto., must be smaller than or equal to 200.');
        }
