 ...
 *
 * @category Class
 * @description Referece to another document
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentReferenceInputDto implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((strlen($this->container['document_referred']) > 100)) {
        ...
        if (!is_null($this->container['other_reference_type_id']) && (strlen($this->container['other_reference_type_id']) > 100)) {
            $invalidProperties[] = "invalid value for 'other_reference_type_id', the character length must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['other_reference_type_description']) && (strlen($this->container['other_reference_type_description']) > 100)) {
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['other_reference_type_id']) > 100) {
            return false;
        }
        if (strlen($this->container['other_reference_type_description']) > 100) {
            return false;
        }
        return true;
    }
     ...
     *
     * @param string $document_referred Document number referred. Example: PRUE98745631; MaxLength: 100
     *
     * @return $this
     */
    public function setDocumentReferred($document_referred)
    {
        if ((strlen($document_referred) > 100)) {
     ...
     * Sets issue_date
     *
     * @param string $issue_date Date when refered to invoice
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Type of document reference. See DataElements.DocReferenceType
     *
     * @return $this
     */
     ...
     *
     * @param string $other_reference_type_id If Type=OtherReference use this field to set the custom type ID; MaxLength: 100
     *
     * @return $this
     */
    public function setOtherReferenceTypeId($other_reference_type_id)
    {
        if (!is_null($other_reference_type_id) && (strlen($other_reference_type_id) > 100)) {
     ...
     *
     * @param string $other_reference_type_description If Type=OtherReference use this field to set the custom description of the reference; MaxLength: 100
     *
     * @return $this
     */
    public function setOtherReferenceTypeDescription($other_reference_type_description)
    {
        if (!is_null($other_reference_type_description) && (strlen($other_reference_type_description) > 100)) {
