...
/**
 * TaxSummaryDTO Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TaxSummaryDTO implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TaxSummaryDTO';
    ...
    /**
     * Sets tax_category
     * @param string $tax_category Tax type or class. The value must be one of this ['IVA', 'IPO', 'ICA']
     * @return $this
     */
    ...
    /**
     * Sets taxable_amount
     * @param string $taxable_amount Taxable: Taxable income on which withholding tax is calculated
     * @return $this
     */
